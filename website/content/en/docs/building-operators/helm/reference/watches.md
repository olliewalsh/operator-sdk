...
| dryrunOption            | The helm dry-run method to use when comparing manifests. Set to `server` to ensure `lookup()` functions are evaluated before comparision (default: `client/none`) |
